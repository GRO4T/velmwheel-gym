...
class AStarPlanner:
    ...
    def planning(self, sx, sy, gx, gy):
        ...
        while True:
            if len(open_set) == 0:
                logger.debug("Open set is empty..")
                break
    ...
    def calc_obstacle_map(self, ox, oy):
        ...
        # logger.debug(f"min_x:{self.min_x}")
        # logger.debug("min_y:", self.min_y)
        # logger.debug("max_x:", self.max_x)
        # logger.debug("max_y:", self.max_y)

        self.x_width = round((self.max_x - self.min_x) / self.resolution)
        self.y_width = round((self.max_y - self.min_y) / self.resolution)
        # logger.debug("x_width:", self.x_width)
        # logger.debug("y_width:", self.y_width)
